...
if("TRUE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /home/nicholaskwan-wong/roshydro/src/perception_pcl/pointcloud_to_laserscan)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /home/nicholaskwan-wong/roshydro/devel)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /home/nicholaskwan-wong/roshydro/install)
...
if(NOT "/home/nicholaskwan-wong/roshydro/src/perception_pcl/pointcloud_to_laserscan/include" STREQUAL "")
  set(pointcloud_to_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/nicholaskwan-wong/roshydro/src/perception_pcl/pointcloud_to_laserscan/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nicholaskwan-wong/roshydro/src/perception_pcl/pointcloud_to_laserscan/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
    endif()
...
set(depends "dynamic_reconfigure;libpcl-all-dev;message_filters;nodelet;pcl_ros;roscpp;sensor_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pointcloud_to_laserscan_dep}_FOUND)
      find_package(${pointcloud_to_laserscan_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pointcloud_to_laserscan_dep} REQUIRED ${depend_list})
  endif()
