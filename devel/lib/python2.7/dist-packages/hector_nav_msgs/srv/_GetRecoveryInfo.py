...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2Id.pack(_x.request_time.secs, _x.request_time.nsecs, _x.request_radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.request_time.secs, _x.request_time.nsecs, _x.request_radius,) = _struct_2Id.unpack(str[start:end])
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.trajectory_radius_entry_pose_to_req_pose.header.seq, _x.trajectory_radius_entry_pose_to_req_pose.header.stamp.secs, _x.trajectory_radius_entry_pose_to_req_pose.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.radius_entry_pose.header.seq, _x.radius_entry_pose.header.stamp.secs, _x.radius_entry_pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.req_pose.pose.position.x, _x.req_pose.pose.position.y, _x.req_pose.pose.position.z, _x.req_pose.pose.orientation.x, _x.req_pose.pose.orientation.y, _x.req_pose.pose.orientation.z, _x.req_pose.pose.orientation.w))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.trajectory_radius_entry_pose_to_req_pose.header.seq, _x.trajectory_radius_entry_pose_to_req_pose.header.stamp.secs, _x.trajectory_radius_entry_pose_to_req_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.radius_entry_pose.header.seq, _x.radius_entry_pose.header.stamp.secs, _x.radius_entry_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.req_pose.pose.position.x, _x.req_pose.pose.position.y, _x.req_pose.pose.position.z, _x.req_pose.pose.orientation.x, _x.req_pose.pose.orientation.y, _x.req_pose.pose.orientation.z, _x.req_pose.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
