...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_f3I.pack(_x.distance, _x.end_point.header.seq, _x.end_point.header.stamp.secs, _x.end_point.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.end_point.point.x, _x.end_point.point.y, _x.end_point.point.z))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.distance, _x.end_point.header.seq, _x.end_point.header.stamp.secs, _x.end_point.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.end_point.point.x, _x.end_point.point.y, _x.end_point.point.z,) = _struct_3d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
