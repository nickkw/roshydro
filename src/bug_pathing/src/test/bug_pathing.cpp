...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    else if((noObstacleCounter < 7) && (range_f < (range_thresh_ - 0.15)) || (range_f_l < (range_thresh_ - 0.15)) || (range_f_r < (range_thresh_ - 0.15))) {
      noObstacleCounter--;
    ...
    // if all sensor ranges > range_thresh_ cm, move on
    else if((noObstacleCounter >= 7) && (range_f > range_thresh_) && (range_f_l > range_thresh_) && (range_f_r > range_thresh_) && (range_l > range_thresh_) && (range_r > range_thresh_)) {
      ...
      noObstacleCounter++;
      noObstacleCounter = fmin(noObstacleCounter, 10);
